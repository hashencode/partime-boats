...
import { StepFormRecipe, type StepFormSpec } from '../../../shared/template-kit/form'
...
export const StepFormPage = () => {
  ...
  const goNext = async () => {
    if (current === 0) {
      const values = await form.validateFields(['payAccount', 'receiverMode', 'receiverAccount', 'receiverName', 'amount'])
