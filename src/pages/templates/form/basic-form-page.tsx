      ...
      renderFields: () => (
        <>
          ...
          <Form.Item label="起止日期" name="dateRange" rules={[{ required: true, message: '请选择起止日期' }]}>
            <RangePicker className="w-full md:!w-[320px]" />
          </Form.Item>
          ...
          <Form.Item
            ...
            name="client"
          >
            <Input placeholder="请描述你服务的客户，内部客户直接 @姓名/工号" className="md:!w-[320px]" />
          </Form.Item>
          ...
          <Form.Item
            ...
            name="invites"
          >
            <Input placeholder="请直接 @姓名/工号，最多可邀请 5 人" className="md:!w-[320px]" />
          </Form.Item>
